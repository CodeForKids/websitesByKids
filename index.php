	  ...
	  <div class="header header_bar">
		<div class="container"> 
		  <div class="four columns logo">
			<a href="http://code-for-kids.ca" title="Code For Kids">
				<img src="//cdn.shopify.com/s/files/1/0223/1913/t/6/assets/logo.png?9252" alt="Code For Kids" data-src="//cdn.shopify.com/s/files/1/0223/1913/t/6/assets/logo.png?9252">
			</a>
		  </div>
		  <div class="twelve columns nav mobile_hidden">
			<ul class="menu">
				  <li><a href="http://code-for-kids.ca" title="Code For Kids" class="sub-menu">Code For Kids</a>
			</ul>
		  </div>
		</div>
	  </div>
	  ...
	  <div class="container main content"> 
		  <div class="inner-left">
			<a class="anchor" id="newsletter"></a>
			  <h6 class="title">News &amp; Event Updates</h6>
			<p style="color:white;">Join our mailing list to receive event details and updates!</p>
		  ...
		  <div class="inner-right">
				  <h4 class="title" style="color:white;">Sponsors</h4>
				<a href="#" id="sponsors" class="anchor"></a>
				<a href="http://www.cira.ca/">
				<img src="//cdn.shopify.com/s/files/1/0223/1913/t/6/assets/CIRA_DotCA-en-white.png?9252" alt="CIRA .CA Logo" height="75">
				</a>
		  </div>
		</div>
		</div>
